...
public class PostDAO {
	...
	public ArrayList<PostVO> getPostingList(PagingBean pagingBean) throws SQLException {
		...
		try {
			...
			sql.append(
					"FROM(SELECT row_number() over(ORDER BY hobbypost_no DESC) as rnum,hobbypost_no,hobby_title,hobbypost_viewcount,to_char(hobbypost_date,'YYYY.MM.DD') as time_posted,id FROM hobby_post ");
